...
const mapRelacionamentos: { [key: string]: { acoes: string[], panes?: string[] } } = {
    ...
    'TO01': { acoes: ['PR13', 'PR27', 'PR44', 'PR51', 'PR53'], panes: [] },
    ...
    'TO11': { acoes: ['PR01', 'PR13', 'PR29', 'PR51'], panes: [] },
    'TO12': { acoes: ['PR11', 'PR17', 'PR50', 'PR51', 'PR57', 'PR58', 'PR59', 'PR61'], panes: [] },
    'TO13': { acoes: ['PR12', 'PR13', 'PR37', 'PR51'], panes: [] },
    'TO14': { acoes: ['PR07', 'PR13', 'PR19', 'PR44', 'PR51'], panes: [] },
    'TO15': { acoes: ['PR01', 'PR09', 'PR13', 'PR25', 'PR35', 'PR36', 'PR51', 'PR53', 'PR54'], panes: [] },
    'TO16': { acoes: ['PR01', 'PR11', 'PR20', 'PR38', 'PR51'], panes: [] },
    'TO17': { acoes: ['PR15', 'PR16', 'PR30', 'PR51'], panes: [] },
    'TO18': { acoes: ['PR13', 'PR22', 'PR37', 'PR51'], panes: [] },
    'TO19': { acoes: ['PR01', 'PR09', 'PR13', 'PR17', 'PR51', 'PR53'], panes: [] },
    'TO20': { acoes: ['PR07', 'PR13', 'PR51'], panes: [] },
    'TO21': { acoes: ['PR39', 'PR40', 'PR41', 'PR51'], panes: [] },
    'TO23': { acoes: ['PR17', 'PR46', 'PR47', 'PR51'], panes: [] },
    'TO24': { acoes: ['PR44', 'PR51'], panes: [] },
    'TO25': { acoes: ['PR13', 'PR21', 'PR22', 'PR23', 'PR37', 'PR51'], panes: [] },
    'TO30': { acoes: ['PR09', 'PR17', 'PR51'], panes: [] },
    'TO33': { acoes: ['PR01', 'PR13', 'PR51', 'PR53', 'PR54'], panes: [] },
