...
const mapRelacionamentos: { [key: string]: { acoes: string[], panes?: string[] } } = {
    ...
    'TO01': { acoes: ['PR13', 'PR27', 'PR44', 'PR51'], panes: [] },
    'TO02': { acoes: ['PR02', 'PR13', 'PR37', 'PR51'], panes: [] },
    'TO03': { acoes: ['PR03', 'PR04', 'PR05', 'PR13', 'PR33', 'PR56', 'PR51'], panes: [] },
    ...
    'TO15': { acoes: ['PR09', 'PR13', 'PR35', 'PR36', 'PR51'], panes: [] },
    'TO16': { acoes: ['PR11', 'PR20', 'PR38', 'PR51'], panes: [] },
    'TO17': { acoes: ['PR15', 'PR16', 'PR30', 'PR51'], panes: [] },
    'TO18': { acoes: ['PR13', 'PR22', 'PR37', 'PR51'], panes: [] },
    'TO19': { acoes: ['PR01', 'PR09', 'PR13', 'PR17', 'PR51'], panes: [] },
    ...
    'TO33': { acoes: ['PR13', 'PR63', 'PR51'], panes: [] },
    'TO34': { acoes: ['PR13', 'PR14', 'PR62', 'PR51'], panes: [] },
    ...
    'TO50': { acoes: ['PR09', 'PR17', 'PR28', 'PR38', 'PR60', 'PR51'], panes: [] },
};
