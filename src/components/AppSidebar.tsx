        ...
        <div className="flex items-center justify-center space-x-2">
           <h1 className="text-2xl font-bold text-white flex items-center justify-center gap-2">
            ...
            <div className="flex h-6 items-center gap-1.5">
              ...
              <div className="w-0.5 h-full bg-repeat-y bg-[length:3px_15px] bg-center animate-move-dashes" style={{ backgroundImage: "linear-gradient(to bottom, white 60%, transparent 40%)"}}></div>
            </div>
            PRIORIDADE
          </h1>
        </div>
