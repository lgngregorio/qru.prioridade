...
export default function TO37Form({ categorySlug }: { categorySlug: string }) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Field label="AÇÃO">
                <RadioGroup value={sinalizacaoInfo.acao} onValueChange={(value) => handleSinalizacaoInfoChange('acao', value)} className="flex flex-col space-y-2">
                    <div className="flex items-center space-x-2"><RadioGroupItem value="FAZER IMPLANTAÇÃO DA PLACA" id="a-implantacao" /><Label htmlFor="a-implantacao" className="text-xl font-normal">FAZER IMPLANTAÇÃO DA PLACA</Label></div>
                    <div className="flex items-center space-x-2"><RadioGroupItem value="FEITO A RETIRADA DA PLACA" id="a-retirada" /><Label htmlFor="a-retirada" className="text-xl font-normal">FEITO A RETIRADA DA PLACA</Label></div>
                    <div className="flex items-center space-x-2"><RadioGroupItem value="FEITO O DESAMASSO DA PLACA" id="a-desamasso" /><Label htmlFor="a-desamasso" className="text-xl font-normal">FEITO O DESAMASSO DA PLACA</Label></div>
