        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Field label="TIPO DE DEFEITO">
                <RadioGroup value={generalInfo.tipoDeDefeito} onValueChange={(value) => handleGeneralInfoChange('tipoDeDefeito', value)} className="flex flex-col space-y-2">
                    <div className="flex items-center space-x-2"><RadioGroupItem value="buraco" id="td-buraco" /><Label htmlFor="td-buraco" className="text-xl font-normal">BURACO</Label></div>
                    <div className="flex items-center space-x-2"><RadioGroupItem value="deformidade" id="td-deformidade" /><Label htmlFor="td-deformidade" className="text-xl font-normal">DEFORMIDADE</Label></div>
                </RadioGroup>
            </Field>
