  ...
  return (
    <div className="w-full p-4 sm:p-6 md:p-8">
      <form className="space-y-12" onSubmit={(e) => e.preventDefault()}>
        ...
        <Field label="Sinalização semáforo">{renderRadioGroup('sinalizacao', 'semaforo', [{id: "funciona", label: "Funciona"}, {id: "nao_funciona", label: "Não funciona"}, {id: "funciona_com_defeito", label: "Funciona com defeito"}, {id: "inexistente", label: "Inexistente"}])}</Field>

        <div className="flex sm:flex-row gap-4 pt-6">
          <Button size="lg" className="flex-1 bg-green-600 hover:bg-green-700 uppercase text-base" onClick={() => {}}>
              <Share className="mr-2 h-4 w-4" />
              Compartilhar WhatsApp
          </Button>
          <Button size="lg" className="w-32 bg-primary hover:bg-primary/90 uppercase text-base" onClick={() => {}} >
