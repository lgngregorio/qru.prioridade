...
export default function OcorrenciasPage() {
    ...
    // Mostra o loader enquanto o usuário está sendo verificado ou os relatórios estão sendo carregados.
    ...
    // Se não há usuário após o carregamento, não renderiza nada (será redirecionado pelo AuthGuard)
    if (!user) {
        return null;
    }
