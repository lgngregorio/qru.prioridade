           ...
           <div className="flex items-center gap-4 justify-center relative">
             ...
             <h1 className="text-4xl font-bold text-foreground font-headline tracking-wider flex items-center justify-center gap-3">
                ...
                <div className="flex h-10 items-center gap-1">
                  ...
                  <div className="w-1 h-full bg-repeat-y bg-[length:4px_28px] bg-center animate-move-dashes" style={{ backgroundImage: "linear-gradient(to bottom, white 60%, transparent 40%)"}}></div>
                </div>
                PRIORIDADE
              </h1>
           </div>
